import {all, char, createTokenizer, maybe, or, Rule, seq, text, until} from 'tokenizer-dsl';
import {ParserContext} from './parseJson';
...
const stringReader = seq(text('"'), until(text('"'), {inclusive: true}));
